...
<div className="h-[calc(85vh-96px)] flex flex-col items-center justify-center px-4 text-center">
  ...
  <p className="mt-16 text-lg md:text-xl text-gray-500 max-w-3xl">
    Studies at IIT go beyond memorizing lecture notes. They emphasize understanding concepts, 
    applying knowledge, and generating new ideas through classes, tutorials, and labs. 
    The campus offers access to labs, libraries, and other facilities beyond regular hours, 
    with opportunities to interact with leading professionals from around the world. 
    Students also benefit from group projects, discussions, and learning from peers. 
    Despite being a newer IIT, IIT Guwahati graduates have made significant impacts across academia and industry.
  </p>
</div>
